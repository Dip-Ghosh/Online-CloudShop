	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="index.html" style="color: tomato;"><span>Cloud</span>Shop</a></h1>
			</div>
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="products.html">Clothings</a></li>
										...
										<div class="snipcart-details top_brand_home_details">
											<form action="checkout.html" method="post">
												<fieldset>
													...
													<p style="font-style: italic; color: red;">You Need to <a href="userlogin.php">Log in </a> To unlock 'Add To Cart' Feature</p>
